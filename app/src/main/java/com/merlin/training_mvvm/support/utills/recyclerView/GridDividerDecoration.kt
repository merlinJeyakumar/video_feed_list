package com.merlin.training_mvvm.support.utills.recyclerView
 ...
 */
(private val mHorizontalDivider: Drawable, private val mVerticalDivider: Drawable, private val mNumColumns: Int) : RecyclerView.ItemDecoration() {
